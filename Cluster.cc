...
bool Cluster::modificar_cluster(const string& id_procesador) {
...
bool Cluster::alta_proceso_procesador(const Proceso& proceso, const string& id_procesador) {
    ;//implementar recursivamente la búsqueda
}

bool Cluster::baja_proceso_procesador(const Proceso& proceso, const string& id_procesador) {
    ;//implementar recurs.
}

bool Cluster::alta_proceso(const Proceso& proceso, bool& colocado) {
    ;//implementar recurs.
}
...
bool Cluster::imprimir_procesador(const string& id_procesador) const {
    ;//implementar recurs.
}
