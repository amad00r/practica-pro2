...
class Proceso {
    ...
    public:
        ...
        */
        ...
        /** @brief Constructora inicializadora de identificador, memoria y tiempo de ejecución estimado.
            \pre id >= 0, memoria > 0, tiempo_estimado > 0.
            \post El resultado es un Proceso inicializado con identificador, memoria y tiempo de ejecución estimado.
        */  
        ...
        */
        ...
        /** @brief Consulta si un determinado identificador coincide con el del parámetro implícito.
            ...
            \post El resultado indica si el identificador del parámetro implícito coincide con id_proceso.
        */
        ...
        /** @brief Avanza el tiempo que ha transcurrido en la ejecución del parámetro implícito.
            \pre t >= 0.
            \post tiempo_estimado = tiempo_estimado - t. El resultado indica si tiempo_estimado > 0.
        */
        ...
        /** @brief Imprime el parámetro implícito por el canal de salida estándar.
            \pre El parámetro implícito está inicializado.
            \post Quedan escritos en el canal de salida estándar el identificador, la memoria, y el tiempo restante estimado de ejecución del parámetro implícito.
        */
        void imprimir() const;
};