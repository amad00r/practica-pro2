...
int Proceso::consultar_id()               const { return id; }
bool Proceso::id_coincide(int id_proceso) const { return id == id_proceso; }
int Proceso::consultar_memoria()          const { return memoria; }
